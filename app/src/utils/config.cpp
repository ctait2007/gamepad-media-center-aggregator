...
std::unordered_map<AppConfig::Item, AppConfig::Option> AppConfig::settingMap = {
    ...
    {TMDB_MODERN_HOME, {"tmdb_modern_home_enabled"}},
    {TMDB_ENRICH_CW, {"tmdb_enrich_continue_watching"}},
    {TMDB_LANGUAGE, {"tmdb_language"}},
    {TMDB_USE_ARTWORK, {"tmdb_use_artwork"}},
    {TMDB_USE_BASIC_INFO, {"tmdb_use_basic_info"}},
    {TMDB_USE_DETAILS, {"tmdb_use_details"}},
    {TMDB_USE_RELEASE_DATES, {"tmdb_use_release_dates"}},
    {TMDB_USE_CREDITS, {"tmdb_use_credits"}},
    {TMDB_USE_PRODUCTIONS, {"tmdb_use_productions"}},
    {TMDB_USE_NETWORKS, {"tmdb_use_networks"}},
    {TMDB_USE_EPISODES, {"tmdb_use_episodes"}},
